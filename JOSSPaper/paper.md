...
The PWApp is a MATLAB software package enabling scientific research involving pulse wave velocity (PWV) estimation and splitting of the pulse waves into forward and backwards travelling wave from MRI-based 2D or 4D blood flow velocity data. A graphical user interface simplifies investigations regarding PWV estimation and enables proper comparison and testing of state-of-the-art and novel methods for MRI flow-data based PWV estimation.
